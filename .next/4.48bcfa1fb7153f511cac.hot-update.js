...
function (_Component) {
  ...
  _createClass(Dapps, [{
    ...
    value: function setVersion() {
      //let version;
      __WEBPACK_IMPORTED_MODULE_3__ethereum_web3__["a" /* default */].version.getNode(function (err, result) {
        if (err) {
          return err;
        } else {
          return result;
    ...
    value: function render() {
      ...
      }, "Setup")))), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_bloomer__["Column"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 83
        }
      ...
      }, this.setVersion(__WEBPACK_IMPORTED_MODULE_3__ethereum_web3__["a" /* default */])))))))), " ");
    }
  }]);
...
//# sourceMappingURL=4.48bcfa1fb7153f511cac.hot-update.js.map