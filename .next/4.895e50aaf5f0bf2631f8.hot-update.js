...
function (_Component) {
  ...
  _createClass(Dapps, [{
    ...
    value: function checkMetamask() {
      console.log("check metamask"); //this.setState({metamask: web3})
    }
  }, {
    key: "render",
    value: function render() {
      console.log("what is in ", __WEBPACK_IMPORTED_MODULE_4__ethereum_web3__["a" /* default */]);
      ...
      }, " The playground page "), __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement("p", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 34
        }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (!(__WEBPACK_IMPORTED_MODULE_4__ethereum_web3__["a" /* default */] == '')) {
                  _context.next = 4;
                  break;
                }

                this.setState({
                  errorMessage: 'please install metamast'
                });
                return _context.abrupt("return", __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_bloomer__["Message"], {
                  error: true,
                  header: "Oops!",
...
//# sourceMappingURL=4.895e50aaf5f0bf2631f8.hot-update.js.map