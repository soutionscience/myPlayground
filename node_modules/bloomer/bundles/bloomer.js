...
function getColorModifiers(_a) {
    ...
    return isColor(color) ? (_b = {}, _b["is-" + color] = true, _b) : {};
    var _b;
}
...
var getColorModifier = function (modifier) {
    return isColor(modifier) ? (_a = {}, _a["has-text-" + modifier] = true, _a) : {};
    var _a;
};
...
function Icon(_a) {
    var icon = _a.icon, children = _a.children, props = tslib_1.__rest(_a, ["icon", "children"]);
    var className = classNames('icon', tslib_1.__assign({}, (isAlignOption(props.isAlign) ? (_b = {}, _b["is-" + props.isAlign] = true, _b) : {}), bulma_1.getSizeModifiers(props)), props.className);
    var HTMLProps = helpers_1.getHTMLProps(props, bulma_1.removeAlignmentProps, bulma_1.removeSizeProps);
    var withIcon = (React.createElement("span", tslib_1.__assign({}, HTMLProps, { className: className }),
        React.createElement("span", { className: "fa fa-" + icon, "aria-hidden": "true" })));
    return icon ? withIcon : React.createElement("span", tslib_1.__assign({}, HTMLProps, { children: children, className: className }));
    var _b;
}
exports.Icon = Icon;
...
function DropdownItem(_a) {
    var _b = _a.tag, tag = _b === void 0 ? 'div' : _b, render = _a.render, props = tslib_1.__rest(_a, ["tag", "render"]);
    var className = classNames('dropdown-item', tslib_1.__assign({}, bulma_1.getActiveModifiers(props)), props.className) || undefined;
    var HTMLProps = helpers_1.getHTMLProps(props, bulma_1.removeActiveModifiers);
    if (render)
        return render(tslib_1.__assign({}, HTMLProps, { className: className }));
...
function PanelIcon(_a) {
    var children = _a.children, icon = _a.icon, props = tslib_1.__rest(_a, ["children", "icon"]);
    var className = classNames('panel-icon', props.className);
    var withIcon = (React.createElement("span", tslib_1.__assign({}, props, { className: className }),
        React.createElement("span", { className: "fa fa-" + icon, "aria-hidden": "true" })));
    return icon ? withIcon : React.createElement("span", tslib_1.__assign({}, props, { children: children, className: className }));
}
...
function TabList(_a) {
    var _b = _a.tag, tag = _b === void 0 ? 'ul' : _b, props = tslib_1.__rest(_a, ["tag"]);
    var className = classNames(tslib_1.__assign({}, (isAlignOption(props.isAlign) ? (_c = {}, _c["is-" + props.isAlign] = true, _c) : {})), props.className) || undefined;
