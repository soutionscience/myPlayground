...
export declare function NavbarStart({tag, ...props}: NavbarStart<HTMLElement>): React.DetailedReactHTMLElement<{
    className: string;
    accept?: string;
...
declare const HOC: React.StatelessComponent<NavbarStart<HTMLElement> & React.HTMLProps<HTMLElement> & Bulma.Helpers>;
export default HOC;
