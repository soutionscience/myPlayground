...
export declare function Page({tag, ...props}: Page<HTMLElement>): React.DetailedReactHTMLElement<{
    accept?: string;
...
declare const HOC: React.StatelessComponent<Page<HTMLElement> & React.HTMLProps<HTMLElement> & Bulma.Helpers>;
export default HOC;
