...
export declare function Panel({tag, ...props}: Panel<HTMLElement>): React.DetailedReactHTMLElement<{
    className: string;
    accept?: string;
...
declare const HOC: React.StatelessComponent<Panel<HTMLElement> & React.HTMLProps<HTMLElement> & Bulma.Helpers>;
export default HOC;
