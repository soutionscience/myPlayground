...
export declare function PanelHeading({tag, ...props}: PanelHeading<HTMLElement>): React.DetailedReactHTMLElement<{
    className: string;
    accept?: string;
...
declare const HOC: React.StatelessComponent<PanelHeading<HTMLElement> & React.HTMLProps<HTMLElement> & Bulma.Helpers>;
export default HOC;
