...
export declare function Container({tag, ...props}: Container<HTMLElement>): React.DetailedReactHTMLElement<{
    className: string;
    accept?: string;
...
declare const HOC: React.StatelessComponent<Container<HTMLElement> & React.HTMLProps<HTMLElement> & Bulma.Helpers>;
export default HOC;
