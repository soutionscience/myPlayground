...
export declare function Hero({tag, ...props}: Hero<HTMLElement>): React.DetailedReactHTMLElement<{
    className: string;
    accept?: string;
...
declare const HOC: React.StatelessComponent<Hero<HTMLElement> & React.HTMLProps<HTMLElement> & Bulma.Helpers>;
export default HOC;
